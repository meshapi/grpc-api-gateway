...
type Schema struct {
	Discriminator         *Extensible[Discriminator]         `json:"discriminator,omitempty" yaml:"discriminator,omitempty"`
	...
	Properties           map[string]*Extensible[Schema] `json:"properties,omitempty" yaml:"properties,omitempty"`
	AdditionalProperties *Extensible[Schema]            `json:"additionalProperties,omitempty" yaml:"additionalProperties,omitempty"`
	Default              any                            `json:"default,omitempty" yaml:"default,omitempty"`
	AllOf                []*Extensible[Schema]          `json:"allOf,omitempty" yaml:"allOf,omitempty"`
	AnyOf                []*Extensible[Schema]          `json:"anyOf,omitempty" yaml:"anyOf,omitempty"`
	OneOf                []*Extensible[Schema]          `json:"oneOf,omitempty" yaml:"oneOf,omitempty"`
	Not                  *Extensible[Schema]            `json:"not,omitempty" yaml:"not,omitempty"`
...
type ItemSpec struct {
	Schema *Extensible[Schema]
	Items  []*Extensible[Schema]
}
